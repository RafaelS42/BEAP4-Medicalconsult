package br.com.rafaelsouza.medicalconsult.config;
...
public class SecurityConfig {
    ...
    public void configureGlobal(AuthenticationManagerBuilder auth) throws Exception {
        ...
        auth.inMemoryAuthentication()
                .withUser("Rafael").password(passwordEncoder.encode("12345")).roles("ADMIN")
                .and()
                .withUser("Andressa").password(passwordEncoder.encode("22345")).roles("PACIENTE")
                .and()
                .withUser("Edgar").password(passwordEncoder.encode("33345")).roles("SECRETARIA");
    }
